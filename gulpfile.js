...
gulp.task('svgMin', function () {
  return gulp.src(paths.svgToMin.src)
      .pipe(svgmin())
      .pipe(gulp.dest(paths.svgToMin.dest));
});
...
gulp.task('build', ['svgMin','svgSpriteBuild','compress', 'sass', 'prettifyAll'], function() { 
});


gulp.task('watch', ['browser-sync'], function() {
  gulp.watch('code/pages/**/*.pug', ['prettifyAll', browserSync.reload]);
  gulp.watch ('code/scss/**/*.scss', ['sass', browserSync.reload]);  
